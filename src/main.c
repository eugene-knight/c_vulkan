...
SY_Vulkan_InstanceInitialize (SY_Vulkan_Context *pContext)
{
        ...
        if (SY_ENABLE_VALIDATION_LAYERS)
                {
                        createInfo.enabledLayerCount
                            = SY_VALIDATION_LAYERS_COUNT;
                        createInfo.ppEnabledLayerNames
                            = &SY_VALIDATION_LAYERS[0];
        ...
        SY_Vector_ConstCharPtr_Release (&extensionNames,
                                        SY_DEFAULT_ALLOCATOR_PTR);
        return result;
}
                                            ...
                                            SY_Vulkan_Functions *pFunctions)
{
        ...
        VkResult result = pFunctions->vkCreateDebugUtilsMessengerEXT (
            pContext->instance, &createInfo, nullptr,
...
main ()
{
        ...
        SY_IGNORE SY_Vulkan_InstanceInitialize (&context);
        SY_IGNORE SY_Vulkan_FunctionPointersInitialize (&context, &functions);
        SY_IGNORE SY_Vulkan_DebugUtilsMessengerEXTInitialize (&context,
                                                              &functions);
        SY_IGNORE SY_Vulkan_PickPhysicalDevice (&context);
        ...
        if (SY_ENABLE_VALIDATION_LAYERS)
                {
                        SY_Vulkan_DebugUtilsMessengerEXTRelease (&context,
                                                                 &functions);
                }
